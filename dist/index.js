...
import { BaseApp as Gr } from "@trymimirai/app-sdk";
/**
* @vue/shared v3.5.17
...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), vn = (e) => e.startsWith("onUpdate:"), ee = Object.assign, bs = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, Jr = Object.prototype.hasOwnProperty, k = (e, t) => Jr.call(e, t), M = Array.isArray, dt = (e) => Tn(e) === "[object Map]", Vo = (e) => Tn(e) === "[object Set]", A = (e) => typeof e == "function", X = (e) => typeof e == "string", lt = (e) => typeof e == "symbol", G = (e) => e !== null && typeof e == "object", ys = (e) => (G(e) || A(e)) && A(e.then) && A(e.catch), Co = Object.prototype.toString, Tn = (e) => Co.call(e), Es = (e) => Tn(e).slice(8, -1), Mo = (e) => Tn(e) === "[object Object]", Ns = (e) => X(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, Lt = /* @__PURE__ */ Ze(
  ...
  (e) => e.replace(Xr, (t, n) => n ? n.toUpperCase() : "")
), Zr = /\B([A-Z])/g, Xe = Vn(
...
let Bs;
const en = () => Bs || (Bs = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function xs(e) {
  if (M(e)) {
    const t = {};
    for (let n = 0; n < e.length; n++) {
      const s = e[n], o = X(s) ? ni(s) : xs(s);
      if (o)
        for (const r in o)
          t[r] = o[r];
    }
...
function Lo(e) {
  if (e.flags & 4 && !(e.flags & 16) || (e.flags &= -17, e.globalVersion === zt) || (e.globalVersion = zt, !e.isSSR && e.flags & 128 && (!e.deps && !e._dirty || !os(e))))
    return;
  e.flags |= 2;
  const t = e.dep, n = W, s = Me;
  W = e, Me = !0;
  try {
    jo(e);
...
class Ss {
  ...
  track(t) {
    if (!W || !Me || W === this.computed)
      return;
    let n = this.activeLink;
    if (n === void 0 || n.sub !== W)
      n = this.activeLink = new hi(W, this), W.deps ? (n.prevDep = W.depsTail, W.depsTail.nextDep = n, W.depsTail = n) : W.deps = W.depsTail = n, Uo(n);
...
const rs = /* @__PURE__ */ new WeakMap(), pt = Symbol(
...
function Le(e, t, n, s, o, r) {
  ...
  if (ws(), t === "clear")
    ...
    const a = M(e), p = a && Ns(n);
    if (a && n === "length") {
      const d = Number(s);
      i.forEach((f, g) => {
        (g === "length" || g === Jt || !lt(g) && g >= d) && l(f);
      });
    } else
      switch ((n !== void 0 || i.has(void 0)) && l(i.get(n)), p && l(i.get(Jt)), t) {
        case "add":
          a ? p && l(i.get("length")) : (l(i.get(pt)), dt(e) && l(i.get(is)));
          break;
        case "delete":
          a || (l(i.get(pt)), dt(e) && l(i.get(is)));
          break;
        case "set":
          dt(e) && l(i.get(pt));
          break;
...
function yt(e) {
  const t = F(e);
  return t === e ? t : (ne(t, "iterate", Jt), ge(e) ? t : t.map(le));
}
function Mn(e) {
  return ne(e = F(e), "iterate", Jt), e;
}
const gi = {
  __proto__: null,
  [Symbol.iterator]() {
...
const vi = /* @__PURE__ */ Ze("__proto__,__v_isRef,__isVue"), Ko = new Set(
...
class Wo {
  ...
  get(t, n, s) {
    ...
    return (lt(n) ? Ko.has(n) : vi(n)) || (o || ne(t, "get", n), r) ? l : Q(l) ? i && Ns(n) ? l : l.value : G(l) ? o ? Xo(l) : Ts(l) : l;
  }
}
class Bo extends Wo {
  constructor(t = !1) {
...
const bi = /* @__PURE__ */ new Bo(), yi = /* @__PURE__ */ new qo(), Ei = /* @__PURE__ */ new Bo(!0), Ni = /* @__PURE__ */ new qo(!0), ls = (e) => e, ln = (e) => Reflect.getPrototypeOf(e);
function xi(e, t, n) {
  return function(...s) {
    const o = this.__v_raw, r = F(o), i = dt(r), l = e === "entries" || e === Symbol.iterator && i, a = e === "keys" && i, p = o[e](...s), d = n ? ls : t ? bn : le;
    return !t && ne(
      r,
      "iterate",
      a ? is : pt
...
function wi(e, t) {
  const n = {
    get(o) {
      ...
      const { has: a } = ln(i), p = t ? ls : e ? bn : le;
      if (a.call(i, o))
        return p(r.get(o));
      if (a.call(i, l))
        return p(r.get(l));
    ...
    get size() {
      ...
      return !e && ne(F(o), "iterate", pt), Reflect.get(o, "size", o);
    },
    has(o) {
      const r = this.__v_raw, i = F(r), l = F(o);
    ...
    forEach(o, r) {
      const i = this, l = i.__v_raw, a = F(l), p = t ? ls : e ? bn : le;
      return !e && ne(a, "iterate", pt), l.forEach((d, f) => o.call(r, p(d), p(f), i));
    }
  };
  return ee(
    n,
    e ? {
      ...
      add(o) {
        !t && !ge(o) && !We(o) && (o = F(o));
        const r = F(this);
        return ln(r).has.call(r, o) || (r.add(o), Le(r, "add", o, o)), this;
      },
      set(o, r) {
        !t && !ge(r) && !We(r) && (r = F(r));
        const i = F(this), { has: l, get: a } = ln(i);
        let p = l.call(i, o);
        p ? process.env.NODE_ENV !== "production" && zs(i, l, o) : (o = F(o), p = l.call(i, o));
        const d = a.call(i, o);
        return i.set(o, r), p ? rt(r, d) && Le(i, "set", o, r, d) : Le(i, "add", o, r), this;
      },
      delete(o) {
        const r = F(this), { has: i, get: l } = ln(r);
        let a = i.call(r, o);
        a ? process.env.NODE_ENV !== "production" && zs(r, i, o) : (o = F(o), a = i.call(r, o));
        const p = l ? l.call(r, o) : void 0, d = r.delete(o);
        return a && Le(r, "delete", o, void 0, p), d;
      },
      clear() {
        const o = F(this), r = o.size !== 0, i = process.env.NODE_ENV !== "production" ? dt(o) ? new Map(o) : new Set(o) : void 0, l = o.clear();
        return r && Le(
          o,
          "clear",
          void 0,
...
function Ci(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : Vi(Es(e));
}
function Ts(e) {
  return We(e) ? e : In(
    e,
...
function Ai(e) {
  return !k(e, "__v_skip") && Object.isExtensible(e) && Gt(e, "__v_skip", !0), e;
}
...
class Fi {
  constructor(t, n, s) {
    this.fn = t, this.setter = n, this._value = void 0, this.dep = new Ss(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = zt - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !n, this.isSSR = s;
  }
  /**
   * @internal
   */
...
function ji(e, t, n = !1) {
  ...
  const r = new Fi(s, o, n);
  return process.env.NODE_ENV, r;
}
const an = {}, yn = /* @__PURE__ */ new WeakMap();
let ft;
function Hi(e, t = !1, n = ft) {
  if (n) {
    let s = yn.get(n);
...
function Li(e, t, n = B) {
  const { immediate: s, deep: o, once: r, scheduler: i, augmentJob: l, call: a } = n, p = (V) => {
    (n.onWarn || Ke)(
      "Invalid watch source: ",
      V,
      "A watch source can only be a getter/effect function, a ref, a reactive object, or an array of these types."
    );
  }, d = (V) => o ? V : ge(V) || o === !1 || o === 0 ? Je(V, 1) : Je(V);
  let f, g, x, S, I = !1, te = !1;
  if (Q(e) ? (g = () => e.value, I = ge(e)) : ht(e) ? (g = () => d(e), I = !0) : M(e) ? (te = !0, I = e.some((V) => ht(V) || ge(V)), g = () => e.map((V) => {
    if (Q(V))
      return V.value;
    if (ht(V))
      return d(V);
  ...
  } : (g = se, process.env.NODE_ENV !== "production" && p(e)), t && o) {
  ...
  let U = te ? new Array(e.length).fill(an) : an;
  const ce = (V) => {
  ...
  return l && l(ce), f = new Po(g), f.scheduler = i ? () => i(ce, !1) : ce, S = (V) => Hi(V, !1, f), x = f.onStop = () => {
    const V = yn.get(f);
    if (V) {
      if (a)
        a(V, 4);
...
function N(e, ...t) {
  if (zn) return;
  zn = !0, Ae();
  const n = gt.length ? gt[gt.length - 1].component : null, s = n && n.appContext.config.warnHandler, o = ki();
  if (s)
    Vt(
      s,
      n,
...
function Ki({ vnode: e, recurseCount: t }) {
  ...
  return e.props ? [o, ...Wi(e.props), r] : [o + r];
}
function Wi(e) {
...
function tn(e, t, n, s = !0) {
  ...
  if (t) {
    let l = t.parent;
    const a = t.proxy, p = process.env.NODE_ENV !== "production" ? Vs[n] : `https://vuejs.org/error-reference/#runtime-${n}`;
    for (; l; ) {
      const d = l.ec;
      if (d) {
...
function Bi(e, t, n, s = !0, o = !1) {
  if (process.env.NODE_ENV !== "production") {
    const r = Vs[t];
    if (n && un(n), N(`Unhandled error${r ? ` during execution of ${r}` : ""}`), n && fn(), s)
      throw e;
    console.error(e);
  } else {
    if (o)
...
function $n(e) {
  if (!(e.flags & 1)) {
    const t = Yt(e), n = he[he.length - 1];
    !n || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= Yt(n) ? he.push(e) : he.splice(Gi(t), 0, e), e.flags |= 1, tr();
  }
}
function tr() {
  En || (En = er.then(or));
...
function Xi(e, t) {
  ...
  for (let o = 0; o < s.length; o++) {
    ...
    let l = dn.get(i);
    l || (i !== n.initialDef && Ys(i, t), dn.set(i, l = /* @__PURE__ */ new Set())), l.add(r), r.appContext.propsCache.delete(r.type), r.appContext.emitsCache.delete(r.type), r.appContext.optionsCache.delete(r.type), r.ceReload ? (l.add(r), r.ceReload(t.styles), l.delete(r)) : r.parent ? $n(() => {
...
let Ve, jt = [], as = !1;
function nn(e, ...t) {
  Ve ? Ve.emit(e, ...t) : as || jt.push({ event: e, args: t });
}
function Ms(e, t) {
  var n, s;
  Ve = e, Ve ? (Ve.enabled = !0, jt.forEach(({ event: o, args: r }) => Ve.emit(o, ...r)), jt = []) : /* handle late devtools injection - only do this if we are in an actual */ /* browser environment to avoid the timer handle stalling test runner exit */ /* (#4815) */ typeof window < "u" && // some envs mock window but not fully
  window.HTMLElement && // also exclude jsdom
  // eslint-disable-next-line no-restricted-syntax
  !((s = (n = window.navigator) == null ? void 0 : n.userAgent) != null && s.includes("jsdom")) ? ((t.__VUE_DEVTOOLS_HOOK_REPLAY__ = t.__VUE_DEVTOOLS_HOOK_REPLAY__ || []).push((r) => {
    Ms(r, t);
  }), setTimeout(() => {
    Ve || (t.__VUE_DEVTOOLS_HOOK_REPLAY__ = null, as = !0, jt = []);
  }, 3e3)) : (as = !0, jt = []);
}
function Zi(e, t) {
  nn("app:init", e, t, {
...
function lr(e) {
  return (t, n, s) => {
    nn(e, t.appContext.app, t.uid, t, n, s);
  };
}
function rl(e, t, n) {
  nn(
...
function ar(e) {
  Yr(e) && N("Do not use built-in directive ids as custom directive id: " + e);
}
function ll(e, t) {
  if (fe === null)
...
const cl = Symbol("_vte"), al = (e) => e.__isTeleport;
function Is(e, t) {
...
function Kt(e, t, n, s, o = !1) {
  ...
  const p = t && t.r, d = l.refs === B ? l.refs = {} : l.refs, f = l.setupState, g = F(f), x = f === B ? () => !1 : (S) => process.env.NODE_ENV !== "production" && (k(g, S) && !Q(g[S]) && N(
    `Template ref "${S}" used on a non-ref value. It will not work in the production build.`
  ), ul.has(g[S])) ? !1 : k(g, S);
  if (p != null && p !== a && (X(p) ? (d[p] = null, x(p) && (f[p] = null)) : Q(p) && (p.value = null)), A(a))
    Vt(a, l, 12, [i, d]);
  else {
    const S = X(a), I = Q(a);
    if (S || I) {
      const te = () => {
        if (e.f) {
          const K = S ? x(a) ? f[a] : d[a] : a.value;
          o ? M(K) && bs(K, r) : M(K) ? K.includes(r) || K.push(r) : S ? (d[a] = [r], x(a) && (f[a] = d[a])) : (a.value = [r], e.k && (d[e.k] = a.value));
        } else S ? (d[a] = i, x(a) && (f[a] = i)) : I ? (a.value = i, e.k && (d[e.k] = i)) : process.env.NODE_ENV !== "production" && N("Invalid template ref type:", a, `(${typeof a})`);
      };
...
const Qe = (e) => (t, n = ie) => {
  (!Zt || e === "sp") && Pn(e, (...s) => t(...s), n);
}, hl = Qe("bm"), dr = Qe("m"), gl = Qe(
  "bu"
), ml = Qe("u"), vl = Qe(
  "bum"
), Rs = Qe("um"), _l = Qe(
...
function pr(e, t, n, s) {
  ...
  if (i || X(e)) {
    const l = i && ht(e);
    let a = !1, p = !1;
    l && (a = !ge(e), p = We(e), e = Mn(e)), o = new Array(e.length);
    for (let d = 0, f = e.length; d < f; d++)
      o[d] = t(
        a ? p ? bn(le(e[d])) : le(e[d]) : e[d],
        d,
        void 0,
        r
      );
...
const us = (e) => e ? Fr(e) ? jn(e) : us(e.parent) : null, mt = (
  ...
  get({ _: e }, t) {
    ...
    let f, g;
    if (d)
      return t === "$attrs" ? (ne(e.attrs, "get", ""), process.env.NODE_ENV !== "production" && Dn()) : process.env.NODE_ENV !== "production" && t === "$slots" && ne(e, "get", t), d(e);
    if (
...
function Sl(e) {
  ...
  const {
    ...
    directives: _t,
    filters: Ct
  } = t, ye = process.env.NODE_ENV !== "production" ? Dl() : null;
  if (process.env.NODE_ENV !== "production") {
  ...
  if (ae(hl, f), ae(dr, g), ae(gl, x), ae(ml, S), ae(fl, I), ae(dl, te), ae(El, oe), ae(yl, Z), ae(bl, me), ae(vl, J), ae(Rs, ce), ae(_l, R), M($))
    if ($.length) {
...
function Il(e, t) {
  return function(s, o = null) {
    ...
    const p = r.app = {
      ...
      use(d, ...f) {
        return i.has(d) ? process.env.NODE_ENV !== "production" && N("Plugin has already been applied to target app.") : d && A(d.install) ? (i.add(d), d.install(p, ...f)) : A(d) ? (i.add(d), d(p, ...f)) : process.env.NODE_ENV !== "production" && N(
      ...
      component(d, f) {
        return process.env.NODE_ENV !== "production" && vs(d, r.config), f ? (process.env.NODE_ENV !== "production" && r.components[d] && N(`Component "${d}" has already been registered in target app.`), r.components[d] = f, p) : r.components[d];
      },
      directive(d, f) {
        return process.env.NODE_ENV !== "production" && ar(d), f ? (process.env.NODE_ENV !== "production" && r.directives[d] && N(`Directive "${d}" has already been registered in target app.`), r.directives[d] = f, p) : r.directives[d];
      },
      mount(d, f, g) {
        if (a)
          process.env.NODE_ENV !== "production" && N(
          ...
          const x = p._ceVNode || Se(s, o);
          return x.appContext = r, g === !0 ? g = "svg" : g === !1 && (g = void 0), process.env.NODE_ENV !== "production" && (r.reload = () => {
            const S = it(x);
            S.el = null, e(S, d, g);
          }), e(x, d, g), a = !0, p._container = d, d.__vue_app__ = p, process.env.NODE_ENV !== "production" && (p._instance = x.component, Zi(p, po)), jn(x.component);
        }
      },
      onUnmount(d) {
      ...
      unmount() {
        a ? (Be(
          ...
          p._instance,
          16
        ), e(null, p._container), process.env.NODE_ENV !== "production" && (p._instance = null, Qi(p)), delete p._container.__vue_app__) : process.env.NODE_ENV !== "production" && N("Cannot unmount an app that is not mounted.");
      },
      provide(d, f) {
        return process.env.NODE_ENV !== "production" && d in r.provides && (k(r.provides, d) ? N(
...
function Pl(e, t, n, s = !1) {
  ...
  for (const i in e.propsOptions[0])
    i in o || (o[i] = void 0);
  process.env.NODE_ENV !== "production" && xr(t || {}, o, e), n ? e.props = s ? o : Mi(o) : e.type.props ? e.props = o : e.props = r, e.attrs = r;
}
function Rl(e) {
  for (; e; ) {
...
function Fl(e, t, n, s) {
  ...
  if (
    ...
    !(process.env.NODE_ENV !== "production" && Rl(e)) && (s || i > 0) && !(i & 16)
  ) {
    if (i & 8) {
    ...
    for (const f in l)
      ...
      ((d = Xe(f)) === f || !k(t, d))) && (a ? n && // for camelCase
    ...
    if (r !== l)
      for (const f in r)
        (!t || !k(t, f)) && (delete r[f], p = !0);
  }
  p && Le(e.attrs, "set", ""), process.env.NODE_ENV !== "production" && xr(t || {}, o, e);
}
function Er(e, t, n, s) {
  ...
  if (t)
    for (let a in t) {
      ...
      const p = t[a];
      let d;
      o && k(o, d = Ce(a)) ? !r || !r.includes(d) ? n[d] = p : (l || (l = {}))[d] = p : Rn(e.emitsOptions, a) || (!(a in s) || p !== s[a]) && (s[a] = p, i = !0);
    }
  if (r) {
    const a = F(n), p = l || B;
...
function Nr(e, t, n = !1) {
  const s = n ? jl : t.propsCache, o = s.get(e);
  if (o)
    return o;
  const r = e.props, i = {}, l = [];
  let a = !1;
  ...
  if (M(r))
    for (let d = 0; d < r.length; d++) {
      process.env.NODE_ENV !== "production" && !X(r[d]) && N("props must be strings when using array syntax.", r[d]);
      const f = Ce(r[d]);
      to(f) && (i[f] = B);
    }
  else if (r) {
    ...
    for (const d in r) {
      const f = Ce(d);
      if (to(f)) {
        const g = r[d], x = i[f] = M(g) || A(g) ? { type: g } : ee({}, g), S = x.type;
        let I = !1, te = !0;
        if (M(S))
...
function xr(e, t, n) {
  const s = F(t), o = n.propsOptions[0], r = Object.keys(e).map((i) => Ce(i));
  for (const i in o) {
    let l = o[i];
    l != null && Ll(
      i,
  ...
  if (!(t == null && !i)) {
    if (r != null && r !== !0 && !a) {
      ...
      for (let g = 0; g < d.length && !p; g++) {
        const { valid: x, expectedType: S } = Ul(t, d[g]);
        f.push(S || ""), p = x;
      }
      if (!p) {
        N(Kl(e, t, f));
...
function Kl(e, t, n) {
  ...
  return n.length === 1 && so(o) && !Wl(o, r) && (s += ` with value ${i}`), s += `, got ${r} `, so(r) && (s += `with value ${l}.`), s;
}
function no(e, t) {
...
const js = (e) => e[0] === "_" || e === "$stable", Hs = (e) => M(e) ? e.map(Te) : [Te(e)], Bl = (e, t, n) => {
  if (t._n)
    return t;
  const s = il((...o) => (process.env.NODE_ENV !== "production" && ie && !(n === null && fe) && !(n && n.root !== ie.root) && N(
  ...
  if (e.vnode.shapeFlag & 32) {
    ...
    o && Gt(s, "__", o, !0);
    const r = t._;
    r ? (hs(s, t, n), n && Gt(s, "_", r, !0)) : wr(t, s);
  } else t && Or(e, t);
}, Gl = (e, t, n) => {
...
let Rt, st;
function Et(e, t) {
  e.appContext.config.performance && On() && st.mark(`vue-${t}-${e.uid}`), process.env.NODE_ENV !== "production" && sl(e, t, On() ? st.now() : Date.now());
}
function Nt(e, t) {
  ...
  process.env.NODE_ENV !== "production" && ol(e, t, On() ? st.now() : Date.now());
}
function On() {
...
function Yl(e, t) {
  ...
  const {
    ...
    if (c === u)
      return;
    c && !Ft(c, u) && (_ = rn(c), et(c, m, v, !0), c = null), u.patchFlag === -2 && (y = !1, u.dynamicChildren = null);
    ...
    process.env.NODE_ENV !== "production" && (Gt(y, "__vnode", c, !0), Gt(y, "__vueParentComponent", _, !0)), P && ct(c, null, _, "beforeMount");
    const L = Xl(m, T);
    ...
    let P;
    if (h && at(h, !1), (P = T.onVnodeBeforeUpdate) && je(P, h, u, c), C && ct(u, c, h, "beforeUpdate"), h && at(h, !0), process.env.NODE_ENV !== "production" && Ue && (y = 0, w = !1, b = null), (O.innerHTML && T.innerHTML == null || O.textContent && T.textContent == null) && d(E, ""), b ? (Y(
      c.dynamicChildren,
      b,
      E,
      h,
      ...
      Xn(u, m),
      v
    ), process.env.NODE_ENV !== "production" && hn(c, u)) : w || $e(
      c,
      u,
      E,
      null,
      ...
      y & 1 && c.children !== u.children && d(E, u.children);
    ...
    c.dynamicChildren ? (Y(
      ...
      w,
      E
    ), process.env.NODE_ENV !== "production" ? hn(c, u) : (
      // #2080 if the stable fragment has a key, it's a <template v-for> that may
      //  get moved around. Make sure all root level vnodes inherit el.
      // #2134 or if it's a component root, it may also get moved around
      // as the component is being moved.
      (u.key != null || m && u === m.subTree) && hn(
        c,
        u,
        !0
        /* shallow */
    ...
    const E = c.component = vc(
      c,
      _,
      m
    );
    if (process.env.NODE_ENV !== "production" && E.type.__hmrId && zi(E), process.env.NODE_ENV !== "production" && (un(c), Et(E, "mount")), Ps(c) && (E.ctx.renderer = It), process.env.NODE_ENV !== "production" && Et(E, "init"), yc(E, !1, w), process.env.NODE_ENV !== "production" && Nt(E, "init"), process.env.NODE_ENV !== "production" && Ue && (c.el = null), E.asyncDep) {
      if (m && m.registerDep(E, H, w), !c.el) {
        const y = E.subTree = Se(we);
        K(null, y, u, h);
      }
    } else
      H(
    ...
    process.env.NODE_ENV !== "production" && (fn(), Nt(E, "mount"));
  }, ae = (c, u, h) => {
    const _ = u.component = c.component;
    if (ic(c, u, h))
      if (_.asyncDep && !_.asyncResolved) {
        process.env.NODE_ENV !== "production" && un(u), j(_, u, h), process.env.NODE_ENV !== "production" && fn();
        return;
      } else
        _.next = u, _.update();
    else
    ...
    const E = () => {
      if (c.isMounted) {
        ...
        let q = O, ve;
        process.env.NODE_ENV !== "production" && un(O || c.vnode), at(c, !1), O ? (O.el = z.el, j(c, O, w)) : O = z, T && xt(T), (ve = O.props && O.props.onVnodeBeforeUpdate) && je(ve, L, O, z), at(c, !0), process.env.NODE_ENV !== "production" && Et(c, "render");
        const _e = ro(c);
        ...
        c.subTree = _e, process.env.NODE_ENV !== "production" && Et(c, "patch"), I(
          ...
          m,
          v
        ), process.env.NODE_ENV !== "production" && Nt(c, "patch"), O.el = _e.el, q === null && lc(c, _e.el), P && Ee(P, m), (ve = O.props && O.props.onVnodeUpdated) && Ee(
          () => je(ve, L, O, z),
          m
        ), process.env.NODE_ENV !== "production" && ir(c), process.env.NODE_ENV !== "production" && fn();
      } else {
        let O;
        ...
        (u.shapeFlag & 256 || q && Wt(q.vnode) && q.vnode.shapeFlag & 256) && c.a && Ee(c.a, m), c.isMounted = !0, process.env.NODE_ENV !== "production" && el(c), u = h = _ = null;
      }
    };
    c.scope.on();
    ...
    c.vnode = u, c.next = null, Fl(c, u.props, _, h), Gl(c, u.children, h), Ae(), Js(c), Ie();
    ...
    P & 8 ? (C & 16 && At(b, m, v), O !== b && d(h, O)) : C & 16 ? P & 16 ? Mt(
      b,
      O,
      h,
      _,
    ...
    for (; b <= O && b <= T; ) {
      const P = c[b], L = u[b] = y ? nt(u[b]) : Te(u[b]);
      if (Ft(P, L))
        I(
          P,
          L,
    ...
    for (; b <= O && b <= T; ) {
      const P = c[O], L = u[T] = y ? nt(u[T]) : Te(u[T]);
      if (Ft(P, L))
        I(
          P,
          L,
    ...
    if (b > O) {
      ...
      for (b = L; b <= T; b++) {
        const de = u[b] = y ? nt(u[b]) : Te(u[b]);
        de.key != null && (process.env.NODE_ENV !== "production" && z.has(de.key) && N(
      ...
      for (b = P; b <= O; b++) {
        ...
        if (de.key != null)
          ...
          for (q = L; q <= T; q++)
            if ($t[q - L] === 0 && Ft(de, u[q])) {
              Fe = q;
              break;
            }
        Fe === void 0 ? et(de, m, v, !0) : ($t[Fe - L] = b + 1, Fe >= Re ? Re = Fe : Pe = !0, I(
          de,
          u[Fe],
          h,
          null,
      ...
      for (q = Ks.length - 1, b = _e - 1; b >= 0; b--) {
        const de = L + b, Fe = u[de], Ws = de + 1 < C ? u[de + 1].el : _;
        $t[b] === 0 ? I(
          null,
          Fe,
          h,
    ...
    oo(y), oo(b), _ && xt(_), C && M(O) && O.forEach((T) => {
      ...
      c.isUnmounted = !0;
    }, u), u && u.pendingBranch && !u.isUnmounted && c.asyncDep && !c.asyncResolved && c.suspenseId === u.pendingId && (u.deps--, u.deps === 0 && u.resolve()), process.env.NODE_ENV !== "production" && nl(c);
...
function hn(e, t, n = !1) {
  ...
  if (M(s) && M(o))
    for (let r = 0; r < s.length; r++) {
      const i = s[r];
      let l = o[r];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = o[r] = nt(o[r]), l.el = i.el), !n && l.patchFlag !== -2 && hn(i, l)), l.type === sn && (l.el = i.el), l.type === we && !l.el && (l.el = i.el), process.env.NODE_ENV !== "production" && l.el && (l.el.__vnode = l);
    }
}
function Zl(e) {
  const t = e.slice(), n = [0];
...
const nc = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${Ce(t)}Modifiers`] || e[`${Xe(t)}Modifiers`];
function sc(e, t, ...n) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    if (d)
      if (!(t in d))
        (!f || !(ut(Ce(t)) in f)) && N(
          `Component emitted event "${t}" but it is neither declared in the emits option nor as an "${ut(Ce(t))}" prop.`
        );
      else {
        const g = d[t];
        A(g) && (g(...n) || N(
  ...
  let o = n;
  const r = t.startsWith("update:"), i = r && nc(s, t.slice(7));
  if (i && (i.trim && (o = n.map((d) => X(d) ? d.trim() : d)), i.number && (o = n.map(ss))), process.env.NODE_ENV !== "production" && rl(e, t, o), process.env.NODE_ENV !== "production") {
...
function Rn(e, t) {
  return !e || !Qt(t) ? !1 : (t = t.slice(2).replace(/Once$/, ""), k(e, t[0].toLowerCase() + t.slice(1)) || k(e, Xe(t)) || k(e, t));
}
let gs = !1;
function Dn() {
  gs = !0;
...
function ro(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      ...
      const V = t;
      process.env.NODE_ENV !== "production" && l === f && Dn(), K = Te(
        V.length > 1 ? V(
          process.env.NODE_ENV !== "production" ? ke(f) : f,
    ...
    if (V.length) {
      if (Z & 7)
        ...
        for (let $ = 0, Y = me.length; $ < Y; $++) {
          const re = me[$];
          Qt(re) ? vn(re) || oe.push(re[2].toLowerCase() + re.slice(3)) : R.push(re);
        }
        R.length && N(
...
function ic(e, t, n) {
  ...
  if (n && a >= 0) {
    ...
    return (o || l) && (!l || !l.$stable) ? !0 : s === i ? !1 : s ? i ? lo(s, i, p) : !0 : !!i;
  return !1;
}
function lo(e, t, n) {
...
const De = Symbol.for("v-fgt"), sn = Symbol.for("v-txt"), we = Symbol.for("v-cmt"), Bt = Symbol.for("v-stc"), qt = [];
let xe = null;
function Ne(e = !1) {
  qt.push(xe = e ? null : []);
}
...
let Xt = 1;
function co(e, t = !1) {
  Xt += e, e < 0 && xe && t && (xe.hasOnce = !0);
}
function Ar(e) {
  return e.dynamicChildren = Xt > 0 ? xe || Dt : null, ac(), Xt > 0 && xe && xe.push(e), e;
}
...
function D(e, t = null, n = null, s = 0, o = null, r = e === De ? 0 : 1, i = !1, l = !1) {
  ...
  return l ? (ks(a, n), r & 128 && e.normalize(a)) : n && (a.shapeFlag |= X(n) ? 8 : 16), process.env.NODE_ENV !== "production" && a.key !== a.key && N("VNode created with invalid key (NaN). VNode type:", a.type), Xt > 0 && // avoid a block node from tracking itself
...
const Se = process.env.NODE_ENV !== "production" ? fc : $r;
function $r(e, t = null, n = null, s = 0, o = null, r = !1) {
  if ((!e || e === Nl) && (process.env.NODE_ENV !== "production" && !e && N(`Invalid vnode type when creating vnode: ${e}.`), e = we), Fn(e)) {
    const l = it(
      e,
      t,
      !0
    ...
    return n && ks(l, n), Xt > 0 && !r && xe && (l.shapeFlag & 6 ? xe[xe.indexOf(e)] = l : xe.push(l)), l.patchFlag = -2, l;
  }
  ...
  const i = X(e) ? 1 : Mr(e) ? 128 : al(e) ? 64 : G(e) ? 4 : A(e) ? 2 : 0;
...
function it(e, t, n = !1, s = !1) {
  const { props: o, ref: r, patchFlag: i, children: l, transition: a } = e, p = t ? hc(o || {}, t) : o, d = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: p,
...
function pc(e, t) {
  const n = Se(Bt, null, e);
  return n.staticCount = t, n;
}
function Qn(e = "", t = !1) {
  return t ? (Ne(), uc(we, null, e)) : Se(we, null, e);
}
function Te(e) {
  return e == null || typeof e == "boolean" ? Se(we) : M(e) ? Se(
    De,
    null,
    // #3666, avoid reference pollution when reusing vnode
    e.slice()
  ) : Fn(e) ? nt(e) : Se(sn, null, String(e));
}
function nt(e) {
...
let mc = 0;
function vc(e, t, n) {
  const s = e.type, o = (t ? t.appContext : e.appContext) || gc, r = {
    uid: mc++,
    vnode: e,
    type: s,
    parent: t,
  ...
  return process.env.NODE_ENV !== "production" ? r.ctx = xl(r) : r.ctx = { _: r }, r.root = t ? t.root : r, r.emit = sc.bind(null, r), e.ce && e.ce(r), r;
}
let ie = null;
const _c = () => ie || fe;
let Sn, ms;
...
function Ec(e, t) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    s.compilerOptions && Nc() && N(
      '"compilerOptions" is only supported when using a build of Vue that includes the runtime compiler. Since you are using a runtime-only build, the options should be passed via your build tool config instead.'
    );
  }
  e.accessCache = /* @__PURE__ */ Object.create(null), e.proxy = new Proxy(e.ctx, hr), process.env.NODE_ENV !== "production" && wl(e);
  const { setup: o } = s;
  if (o) {
    Ae();
    const r = e.setupContext = o.length > 1 ? wc(e) : null, i = on(e), l = Vt(
      o,
      e,
      0,
      [
...
function uo(e, t, n) {
  ...
  ), process.env.NODE_ENV !== "production" && (e.devtoolsRawSetupState = t), e.setupState = Zo(t), process.env.NODE_ENV !== "production" && Ol(e)) : process.env.NODE_ENV !== "production" && t !== void 0 && N(
...
function jn(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(Zo(Ai(e.exposed)), {
    get(t, n) {
      if (n in t)
        return t[n];
      if (n in mt)
...
function Tc() {
  ...
  function p(f, g, x) {
    const S = f[x];
    if (M(S) && S.includes(g) || G(S) && g in S || f.extends && p(f.extends, g, x) || f.mixins && f.mixins.some((I) => p(I, g, x)))
      return !0;
  }
  function d(f) {
...
const kr = _s ? (e) => _s.createHTML(e) : (e) => e, Vc = "http://www.w3.org/2000/svg", Cc = "http://www.w3.org/1998/Math/MathML", ze = typeof document < "u" ? document : null, go = ze && /* @__PURE__ */ ze.createElement("template"), Mc = {
  insert: (e, t, n) => {
  ...
  createElement: (e, t, n, s) => {
    const o = t === "svg" ? ze.createElementNS(Vc, e) : t === "mathml" ? ze.createElementNS(Cc, e) : n ? ze.createElement(e, { is: n }) : ze.createElement(e);
...
const mo = Symbol("_vod"), $c = Symbol("_vsh");
process.env.NODE_ENV;
const Pc = Symbol(process.env.NODE_ENV !== "production" ? "CSS_VAR_TEXT" : ""), Rc = /(^|;)\s*display\s*:/;
function Fc(e, t, n) {
  ...
  if (n && !o) {
    ...
    if (t !== n) {
      const i = s[Pc];
      i && (n += ";" + i), s.cssText = n, r = Rc.test(n);
    }
  } else t && e.removeAttribute("style");
  mo in e && (e[mo] = r ? s.display : "", e[$c] && (s.display = "none"));
}
const jc = /[^\\];\s*$/, vo = /\s*!important$/;
function mn(e, t, n) {
  if (M(n))
...
let ts = 0;
const Kc = /* @__PURE__ */ Promise.resolve(), Wc = () => ts || (Kc.then(() => ts = 0), ts = Date.now());
function Bc(e, t) {
  const n = (s) => {
    if (!s._vts)
      s._vts = Date.now();
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, Gc = (e, t, n, s, o, r) => {
  const i = o === "svg";
  t === "class" ? Ic(e, s, i) : t === "style" ? Fc(e, n, s) : Qt(t) ? vn(t) || kc(e, t, n, s, r) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : zc(e, t, s, i)) ? (Eo(e, t, s), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && yo(e, t, s, i, r, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && (/[A-Z]/.test(t) || !X(s)) ? Eo(e, Ce(t), s, r, t) : (t === "true-value" ? e._trueValue = s : t === "false-value" && (e._falseValue = s), yo(e, t, s, i));
};
function zc(e, t, n, s) {
  if (s)
...
const ns = Symbol("_assign"), Yc = {
  created(e, { modifiers: { lazy: t, trim: n, number: s } }, o) {
    ...
    }), t || (Ot(e, "compositionstart", Jc), Ot(e, "compositionend", So), Ot(e, "change", So));
  },
...
}, Qc = /* @__PURE__ */ ee({ patchProp: Gc }, Mc);
let To;
function ea() {
  return To || (To = Jl(Qc));
}
const ta = (...e) => {
  ...
  process.env.NODE_ENV !== "production" && (sa(t), oa(t));
  const { mount: n } = t;
  return t.mount = (s) => {
    const o = ra(s);
    if (!o) return;
...
const la = { class: "flex justify-between border-b border-border/70 bg-bg-secondary flex-shrink-0" }, ca = { class: "flex" }, aa = ["onClick"], ua = { class: "mr-2" }, fa = /* @__PURE__ */ $s({
  __name: "TabSystem",
  props: {
    activeTab: {},
    tabs: {}
  ...
  setup(e) {
    ...
    return (s, o) => (Ne(), Oe("div", la, [
      D("div", ca, [
        (Ne(!0), Oe(De, null, pr(s.tabs, (r) => (Ne(), Oe("button", {
          key: r.id,
          class: ot(n(r.id)),
          onClick: (i) => s.$emit("tab-change", r.id)
        }, [
          D("span", ua, ue(r.icon), 1),
          Rr(" " + ue(r.label), 1)
        ], 10, aa))), 128))
      ])
    ]));
  }
}), da = { class: "h-full flex flex-col" }, pa = { class: "bg-bg-secondary border-b border-border px-6 py-3" }, ha = { class: "flex items-center justify-between" }, ga = { class: "flex items-center gap-6" }, ma = { class: "flex items-center gap-2" }, va = { class: "flex items-center gap-2" }, _a = { class: "flex items-center gap-4 text-xs text-content-secondary" }, ba = { class: "bg-bg-secondary border-b border-border px-6 py-2" }, ya = { class: "flex items-center gap-2" }, Ea = ["disabled"], Na = { class: "flex-1 min-h-0" }, xa = {
  key: 0,
  class: "h-full p-6"
}, wa = { class: "space-y-6" }, Oa = { class: "card" }, Da = { class: "flex gap-3" }, Sa = ["disabled"], Ta = { class: "card" }, Va = { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, Ca = ["disabled"], Ma = { class: "text-2xl" }, Aa = { class: "text-left" }, Ia = { class: "font-medium text-content" }, $a = {
  key: 1,
  ...
  key: 1,
  class: "space-y-3"
}, Fa = { class: "flex items-center justify-between mb-3" }, ja = { class: "flex items-center gap-3" }, Ha = { class: "text-sm font-medium text-content" }, La = {
  key: 0,
  class: "text-xs text-content-secondary"
}, ka = { class: "text-xs text-content-secondary" }, Ua = { class: "text-sm text-content-secondary whitespace-pre-wrap font-mono" }, Ka = /* @__PURE__ */ $s({
  __name: "MessagingTest",
  setup(e) {
    const t = Ge("messaging"), n = Ge("connecting"), s = Ge("unavailable"), o = Ge(""), r = Ge([]), i = Ge(0), l = Ge(0), a = Ge(null), p = Ge(!1);
    let d = null, f = null, g = 0;
    const x = async () => {
      try {
        if (typeof window < "u" && window.pluginAPI) {
          d = window.pluginAPI, s.value = "available";
          let R = 0;
          const $ = 50;
          for (; (!d.getPluginId() || d.getPluginId() === "") && R < $; )
            await new Promise((re) => setTimeout(re, 100)), R++;
          const Y = d.getPluginId();
          if (console.log(`[MessagingTest] Plugin ID initialized: '${Y}' (attempts: ${R})`), d.messaging) {
            const re = d.messaging.onMessage((ye) => {
              S(ye);
            }), _t = (ye, ae) => {
              console.log("[MessagingTest] Received channel message:", ye, "from:", ae), S(ye);
            }, Ct = d.messaging.subscribeToChannel("test", _t);
            f = () => {
              re && re(), Ct && Ct();
            ...
            console.warn("[MessagingTest] Plugin API found but messaging not available"), n.value = "disconnected";
        } else
          console.warn("[MessagingTest] Plugin API not available"), s.value = "unavailable", n.value = "disconnected";
      } catch (R) {
        console.error("[MessagingTest] Failed to initialize plugin API:", R), s.value = "unavailable", n.value = "disconnected";
      }
    }, S = (R) => {
      ...
      try {
        console.log("[MessagingTest] Sending message:", R), R.type === "ping" && (g = Date.now()), await d.messaging.sendToChannel("test", R), i.value++, r.value.push({
          type: R.type || "custom",
          direction: "sent",
          content: R,
          timestamp: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    ...
    return dr(() => {
      ...
      D("div", Na, [
        t.value === "messaging" ? (Ne(), Oe("div", xa, [
          D("div", wa, [
            D("div", Oa, [
            ...
            D("div", Ta, [
              ...
              D("div", Va, [
                ...
                D("button", {
                  ...
                  D("span", Ma, ue(p.value ? "⏳" : "⚡"), 1),
                  D("div", Aa, [
                    D("div", Ia, ue(p.value ? "Testing..." : "Stress Test"), 1),
        ...
        t.value === "history" ? (Ne(), Oe("div", $a, [
          D("div", {
            class: "flex-1 overflow-y-auto p-6",
            ref_key: "messageList",
            ref: a
          }, [
            r.value.length === 0 ? (Ne(), Oe("div", Pa, $[11] || ($[11] = [
              ...
              (Ne(!0), Oe(De, null, pr(r.value, (Y, re) => (Ne(), Oe("div", {
                key: re,
                class: ot([
                ...
                D("div", Fa, [
                  D("div", ja, [
                    ...
                    Y.responseTime ? (Ne(), Oe("span", La, ue(Y.responseTime) + "ms ", 1)) : Qn("", !0)
                  ]),
                  D("span", ka, ue(Y.timestamp), 1)
                ]),
                D("pre", Ua, ue(te(Y.content)), 1)
              ], 2))), 128))
            ]))
          ], 512)
        ])) : Qn("", !0)
  ...
  for (const [s, o] of t)
    n[s] = o;
  return n;
}, Wa = /* @__PURE__ */ Ur(Ka, [["__scopeId", "data-v-a1804245"]]), Ba = { class: "min-h-screen bg-bg-primary text-content" }, qa = { class: "h-[calc(100vh-80px)] overflow-hidden" }, Ga = /* @__PURE__ */ $s({
  __name: "App",
  setup(e) {
    return (t, n) => (Ne(), Oe("div", Ba, [
      n[0] || (n[0] = pc('<header class="bg-bg-secondary border-b border-border p-4" data-v-149d1035><div class="flex items-center gap-3" data-v-149d1035><div class="w-8 h-8 bg-primary rounded-lg flex items-center justify-center" data-v-149d1035><span class="text-white font-bold text-sm" data-v-149d1035>📡</span></div><div data-v-149d1035><h1 class="text-lg font-semibold text-content" data-v-149d1035>Message Tester</h1><p class="text-xs text-content-secondary" data-v-149d1035>Bidirectional Communication Testing</p></div></div></header>', 1)),
      D("main", qa, [
        Se(Wa)
      ])
    ]));
  }
}), za = /* @__PURE__ */ Ur(Ga, [["__scopeId", "data-v-149d1035"]]);
typeof window < "u" && typeof document < "u" && ta(za).mount("#app");
class Ja extends Gr {
  constructor() {
    super(...arguments);
  ...
  async handleTestChannelMessage(n, s) {
    if (console.log("[MessageTesterApp] Handling test channel message:", n, "from:", s), n.type === "ping" && s !== this.api.getPluginId()) {
    ...
    } else n.type === "ping" && s === this.api.getPluginId() && console.log("[MessageTesterApp] Ignoring ping from self to avoid loop");
  }
}
const Qa = new Ja();
export {
